//  https://github.com/Maaajaaa/DSP_test_inferencing/blob/main/examples/esp32/esp32_fusion/esp32_fusion.ino
...
void B40_init()
{
    ...
    if(B40_ei_connect_fusion_list(EI_CLASSIFIER_FUSION_AXES_STRING) == false) {
